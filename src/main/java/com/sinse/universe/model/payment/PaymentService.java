...
public class PaymentService {
    ...
    public KakaoReadyResponse requestKakaoPayReady(Order order) {
        ...
        params.put("approval_url", rediretUrl + "/api/payment/success?order_id=" + order.getId());        // 결제 성공 시 redirect url, 최대 255자
        params.put("cancel_url", rediretUrl + "/api/payment/cancel");          // 결제 취소 시 redirect url
        params.put("fail_url", rediretUrl + "/api/payment/fail");
